...
ColorSelector.prototype =
{
	...
	init: function(gradient)
	{
      ...
      // hacky fix
      var canvas = scope.container.parentNode;
      var X = event.clientX - scope.container.offsetLeft - canvas.offsetLeft - canvas.parentNode.offsetLeft - canvas.parentNode.parentNode.offsetLeft;
      var Y = event.clientY - scope.container.offsetTop - canvas.parentNode.offsetTop;
      console.log(canvas.offsetLeft, canvas.parentNode.offsetLeft, canvas.parentNode.parentNode.offsetLeft);
      console.log(X, Y);

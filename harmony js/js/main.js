...
function onDocumentMouseDown( event )
{
  ...
  var Y = event.clientY - canvas.parentNode.parentNode.offsetTop;
  
  console.log(isMenuMouseOver, isEventInColorSelector(event.clientX, event.clientY));
...
function onCanvasMouseDown( event )
{
  ...
  var Y = event.clientY - canvas.parentNode.parentNode.offsetTop;
  //var Y = event.clientY;
  console.log(canvas, canvas.parentNode, canvas.parentNode.parentNode);
  console.log(canvas.offsetTop, canvas.parentNode.offsetTop, canvas.parentNode.parentNode.offsetTop);
  console.log(X, Y, 'vs', event.clientX, event.clientY);
...
{
	setBackgroundPng("data:image/png;base64," + data);
}